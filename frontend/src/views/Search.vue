<!-- <template>
  ...
  export default defineComponent({
    ...
    data() {
      return{
        searchBar: '',
        barcodeNum: null as string | null,
    ...
    methods: {
      ...
      async barcodeScanner(): Promise<void>{
        console.log("entered method")
        const videoElement = document.createElement('video');
        this.barcodeNum = await barcodeReader(videoElement);
        if(this.barcodeNum){
          const data = await foodSearch(this.barcodeNum);
          this.foodData = data;
        }
      },
      clearSearchBar(){
    ...
    setup() {
      ...
      async function barcodeNumSearch() {
